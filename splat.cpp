...
#if HD_MODE==0
	#if MAXPAGES==4
	#define SPLAT_ARRAYSIZE 4950
	#endif

	#if MAXPAGES==9
	#define SPLAT_ARRAYSIZE 10870
	#endif

	#if MAXPAGES==16
	#define SPLAT_ARRAYSIZE 19240
	#endif

	#if MAXPAGES==25
	#define SPLAT_ARRAYSIZE 30025
	#endif

	#if MAXPAGES==36
	#define SPLAT_ARRAYSIZE 43217
	#endif

	#if MAXPAGES==49
	#define SPLAT_ARRAYSIZE 58813
	#endif

	#if MAXPAGES==64
	#define SPLAT_ARRAYSIZE 76810
	#endif
...
#if HD_MODE==1
	#if MAXPAGES==1
	#define SPLAT_ARRAYSIZE 5092 
	#endif

	#if MAXPAGES==4
	#define SPLAT_ARRAYSIZE 14844 
	#endif

	#if MAXPAGES==9
	#define SPLAT_ARRAYSIZE 32600
	#endif

	#if MAXPAGES==16
	#define SPLAT_ARRAYSIZE 57713
	#endif

	#if MAXPAGES==25
	#define SPLAT_ARRAYSIZE 90072
	#endif

	#if MAXPAGES==36
	#define SPLAT_ARRAYSIZE 129650
	#endif

	#if MAXPAGES==49 
	#define SPLAT_ARRAYSIZE 176437
	#endif

	#if MAXPAGES==64
	#define SPLAT_ARRAYSIZE 230430
	#endif
...
struct path {	double lat[SPLAT_ARRAYSIZE];
		double lon[SPLAT_ARRAYSIZE];
		double elevation[SPLAT_ARRAYSIZE];
		double distance[SPLAT_ARRAYSIZE];
		int length;
	    }	path;
...
double elev[SPLAT_ARRAYSIZE+10];
...
void ReadPath(struct site source, struct site destination)
{
	...
	for (distance=0.0, c=0; (total_distance!=0.0 && distance<=total_distance && c<SPLAT_ARRAYSIZE); c++, distance=miles_per_sample*(double)c)
	{
...
void PathReport(struct site source, struct site destination, char *name, char graph_it)
{
	...
	char	basename[255], term[30], ext[15], strmode[100],
		report_name[160], block=0, propstring[20];
